...
It will remember their favourite movie and their least favourite movie.*/
...
main()
{
    ...
    //initialize the favRating to 0 so any movie with any rating
    //of 1 or higher will replace it and the leastRating to 10 so
    ...
    do {
        ...
        if(numMovies < 1)
        {
            ...
            printf("No movies! Then how can you rank them?\n Try again!\n\n");
    ...
    for (ctr = 1; ctr <= numMovies; ctr++)
    {
        ...
        scanf(" %s", movieName);
        printf("On a scale of 1 to 10, how would you rate the movie?");
        scanf(" %d", &rating);
