/* This program calculates the average of four grades and also does some other basic maths*/
...
/*The student got 88s on the first and third test, s a multiple assignment statement works.*/
